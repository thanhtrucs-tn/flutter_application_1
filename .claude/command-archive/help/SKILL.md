---
name: help
description: "Usage guide — discover skills and workflows naturally."
...
All-in-one skill guide. Run the script and present output based on type markers.
...
```bash
python .claude/command-archive/help/scripts/help.py "$ARGUMENTS"
```
